...
Generated 2026-09-12 04:59 UTC.
...
| --- | --- | --- | --- |
| 0.0150 | 2.0000 | 0.4944 | yes |
| 0.0300 | 2.0000 | 0.5224 | yes |
| 0.0500 | 2.0000 | 0.5525 | yes |
| 0.0700 | 1.7500 | 0.5788 | no |
| 0.0900 | 1.7500 | 0.6030 | no |
| 0.1100 | 1.7500 | 0.6252 | no |
| 0.1300 | 1.6000 | 0.6465 | no |
| 0.1500 | 1.6000 | 0.6666 | no |
| 0.1700 | 1.6000 | 0.6858 | no |
| 0.2000 | 1.6000 | 0.7130 | no |
| 0.2500 | 1.5000 | 0.7558 | no |
| 0.3500 | 1.5000 | 0.8332 | no |
| 0.6000 | 1.4000 | 1.0003 | no |
| 1.0000 | 1.3000 | 1.2261 | no |

**At a borrowing spread of 0% the retiree wants leverage of 1.60 at the median balance and 2.00 at the most, so the 100% reported in `docs/35` is the grid's answer and not the household's.** Borrowing is worth 2.66% of certainty-equivalent consumption at the median balance and 3.02% at the most, against the unlevered portfolio on the same paths.
...
| --- | --- | --- | --- | --- |
| above the cut-off | 7 | 1.50 | 1.30 | 1.60 |
| below the free area | 3 | 2.00 | 2.00 | 2.00 |
| inside the taper band | 4 | 1.75 | 1.60 | 1.75 |

**The regions differ, but not in the predicted order.** Wanted leverage spans 0.50 across the three, and the ranking is not the one Section 2 of the paper derives. The ceiling was hiding a shape, and it is not the shape that was predicted.
